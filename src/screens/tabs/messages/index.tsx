...
export default function Messages() {
  ...
  return (
    <div className="ygpt-relative ygpt-h-full ygpt-flex-1 ygpt-flex ygpt-flex-col">
      <AnimatedHeader
        style={{ height: TAB_THEME.headerHeights.root, background: layout?.primaryColor || THEME.primaryColor, color: layout?.textOnPrimaryColor || THEME.textOnPrimary }}
      ...
      <motion.button
        ...
        style={{ color: layout?.textOnPrimaryColor || THEME.textOnPrimary, background: layout?.primaryColor || THEME.primaryColor }}
      >
